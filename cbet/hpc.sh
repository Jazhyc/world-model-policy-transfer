...
# Regular
OMP_NUM_THREADS=1 python main.py --model cbet --env CrafterReward-v0 --intrinsic_reward_coef=0.0 --total_frames 1000000 --num_actors 8 --savedir ../logs/impala --xpid Crafter-base-sweep-${SLURM_ARRAY_TASK_ID} --seed ${SLURM_ARRAY_TASK_ID} 
