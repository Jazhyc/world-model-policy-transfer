...
#SBATCH --mem=20gb
#SBATCH --job-name=crafter-stress-impala
## SBATCH --array=0-2
...
# Regular
OMP_NUM_THREADS=1 python main.py --model cbet --env CrafterReward-v0 --intrinsic_reward_coef=0.005 --total_frames 50000000 --num_actors 8 --savedir ../logs/impala --xpid crafter-tabula-rasa-15H

# Pre-train minigrid Doorkey
# OMP_NUM_THREADS=1 python main.py --model cbet --env MiniGrid-DoorKey-8x8-v0 --intrinsic_reward_coef=0.0025 --total_frames 1000000 --num_actors 8 --savedir ../logs/impala --xpid minigrid-pretrain-1M-Doorkey8x8 --no_reward
...
# OMP_NUM_THREADS=1 python main.py --model cbet --env CrafterReward-v0 --intrinsic_reward_coef=0.0025 --total_frames 1000000 --num_actors 8 --savedir ../logs/impala --xpid crafter-pretrain-1M --seed 42 --no_reward
