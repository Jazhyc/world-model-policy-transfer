...
# Regular
OMP_NUM_THREADS=1 python main.py --model cbet --env MiniGrid-Unlock-v0 --intrinsic_reward_coef=0.0025 --total_frames 5000000 --num_actors 8 --savedir ../logs/impala --xpid Minigrid-cbet-sweep-${SLURM_ARRAY_TASK_ID} --seed ${SLURM_ARRAY_TASK_ID} 
